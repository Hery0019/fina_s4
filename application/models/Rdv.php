    ...
    public function check_rdv($id_client, $durre, $id_service) {
        ...
        if ($result) {
            ...
            if ($rdv_time >= $ouverture_time && $rdv_time < $fermeture_time) {
                        ...
                        foreach ($slots as $slot) {
                            ...
                            if ($slot_conflict_query->num_rows() == 0) {
                                ...
                                if ($this->db->affected_rows() > 0) {
                                    ...
                                    return false; // Échec de l'insertion du rendez-vous
                                }
                            }
                        }
                ...
                return false; // Heure de $durre n'est pas entre ouverture et fermeture
            }
        } else {
            return false; // Heures d'ouverture et de fermeture non trouvées
        }
    }
}